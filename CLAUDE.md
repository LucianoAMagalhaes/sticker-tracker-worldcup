...
### Copa do Mundo 2026 (`album-2026.json`, em construção)

Catálogo será adicionado no PR `feat/album-2026`. Resumo:

- 48 seleções × 20 = 960 figurinhas + 20 especiais (Introduction + FIFA Museum) = **980 figurinhas**
- 12 grupos (A–L), sorteio de 5 dez 2025 em Washington
...
2. **`feat/album-2026` — Catálogo da Copa 2026 (próximo)**
   - `data/album-2026.json` com os 12 grupos do sorteio oficial + 48 seleções + blocos especiais (Intro, Museum, Coca)
   - Adicionar entrada no manifest e (a decidir) tornar o 2026 o álbum default no primeiro acesso

3. **`docs/multi-album` — Atualização final da documentação (futuro)**
